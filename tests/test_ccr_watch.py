...
class TestCCRWatch(unittest.TestCase):
    ...
    def test_text_mode_uses_cursor_and_stays_quiet_when_unchanged(self) -> None:
        with tempfile.TemporaryDirectory() as tmp:
            ...
            self.assertIn("Run 20260414T225500Z-1234-abcd1234: state=running", first.stdout)
            self.assertIn("Reviewers: 4/14 completed, 10 running", first.stdout)
            self.assertIn("Reviewer 4/14 finished: security_p1", first.stdout)
